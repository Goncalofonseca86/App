...
export default function WorkAssignment() {
  ...
  const canOnlyViewWorks =
    hasPermission(currentUser, "view_works") &&
    !canAssignWorks &&
    !canCreateWorks;
          ...
          <div>
            ...
            <p className="text-white/90">
              {canAssignWorks
                ...
                : "Consultar e editar informações das obras"}
            </p>
          </div>
                      ...
                      <div className="flex items-center gap-4">
                        {canAssignWorks ? (
                          ...
                          <div className="text-sm text-gray-500 italic">
                            Obra pendente de atribuição
                          </div>
                        )}
                      </div>
                    )}

                    {work.status === "assigned" && work.assignedTo && (
                      <div className="flex items-center justify-between bg-blue-50 p-3 rounded-lg">
                        <div className="flex items-center gap-3">
                          <User className="w-5 h-5 text-blue-600" />
                          <div>
                            <div className="font-medium text-blue-900">
                              {technicians.find((t) => t.id === work.assignedTo)
                                ?.name || "Técnico não encontrado"}
                            </div>
